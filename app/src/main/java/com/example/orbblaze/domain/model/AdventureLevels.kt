...
object AdventureLevels {
    val levels = listOf(
        ...
        Level(2, AdventureZone.JUNGLE, 17, listOf("B G Y P C C", "C C P Y G B", "R B G Y P C"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(3, AdventureZone.JUNGLE, 14, listOf("R R G G B B", "R G B R G B", "B B R R G G"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(4, AdventureZone.JUNGLE, 15, listOf("BBB YPC RBG", "GBR PCY GBR", "BBB CYB PBRG"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(5, AdventureZone.JUNGLE, 7, listOf("RRR BBB GGG", "YYY PPP CCC", "RRR BBB GGG"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(6, AdventureZone.JUNGLE, 14, listOf("R R G G B B", "R G B R G B", "B B R R G G"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(7, AdventureZone.JUNGLE, 18, listOf("RRBB RRBB RR", "GGYY GGYY GG", "PPCC PPCC PP"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(8, AdventureZone.JUNGLE, 8, listOf("R G B Y P C", "R G B Y P C", "R G B Y P C", "R G B Y P C"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(9, AdventureZone.JUNGLE, 20, listOf("B G Y P C C", "C C P Y G B", "R B G Y P C"), LevelObjective.ClearBoard(), 0, 0, 0),
        ...
        Level(13, AdventureZone.JUNGLE, 30, listOf("RGBCCC", "CCBBGR", "RGBBCC", "CCBBGR", "RGBBCC"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(14, AdventureZone.JUNGLE, 20, listOf("RR BB GG YY", "PP CC RR BB", "GG YY PP CC"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(15, AdventureZone.JUNGLE, 10, listOf("RRBBGGYYCC", "BBGGYYCCRR", "RRGGBBYYCC"), LevelObjective.ClearBoard(), 0, 0, 0),
        ...
        Level(21, AdventureZone.CAVE, 15, listOf("R R G G B B", "R G B R G B", "B B R R G G"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(22, AdventureZone.CAVE, 20, listOf("RRRRRBBBBB", "GGGGGYYYYY", "PPPPPCCCCC"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(23, AdventureZone.CAVE, 24, listOf("RR GG BB YY", "RR GG BB YY", "PP CC RR GG", "PP CC RR GG"), LevelObjective.ClearBoard(), 0, 0, 0),
        ...
        Level(27, AdventureZone.CAVE, 22, listOf("RR GG BB YY", "RR GG BB YY", "PP CC RR GG", "PP CC RR GG"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(28, AdventureZone.CAVE, 25, listOf("RRRRR", "RRRRR", "BBBBB", "BBBBB", "GGGGG", "GGGGG"), LevelObjective.ClearBoard(), 0, 0, 0),
        Level(29, AdventureZone.CAVE, 22, listOf("RRRRR", "GGGGG", "BBBBB", "YYYYY", "PPPPP", "CCCCC"), LevelObjective.ClearBoard(), 0, 0, 0),
        ...
        Level(39, AdventureZone.CORE, 35, listOf("RRBBGGYYPP", "RRBBGGYYPP"), LevelObjective.ReachScore(1500), 1100, 1350, 1500),
